...
export const CategoryCreateSchema = z
  .object({
    ...
    is_tampil_di_menu: z.coerce.number().int().min(0).max(1).optional().default(1),
  })
  .openapi('CategoryCreateRequest');
export type CategoryCreate = z.infer<typeof CategoryCreateSchema>;

export const CategoryUpdateSchema = CategoryCreateSchema.partial().openapi('CategoryUpdateRequest');
