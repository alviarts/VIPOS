...
const LoyaltyRuleTypeSchema = z.enum([
  "earn_per_total",
  "earn_per_product",
  "redemption",
]);
...
const MultiplierMapSchema = z.record(
  z.string().regex(/^\d+$/),
...
export const LoyaltyRuleCreateSchema = z
  .object({
    ...
    min_redeem_per_transaction: z.coerce
      .number()
      .int()
      .nonnegative()
      .optional()
      .nullable(),
    max_redeem_per_transaction: z.coerce
      .number()
      .int()
      .nonnegative()
      .optional()
      .nullable(),
    max_redeem_per_day_per_customer: z.coerce
      .number()
      .int()
      .nonnegative()
      .optional()
      .nullable(),
    redemption_block: z.coerce
      .number()
      .int()
      .positive()
      .optional()
      .nullable(),
    points_expire_after_months: z.coerce
      .number()
      .int()
      .nonnegative()
      .optional()
